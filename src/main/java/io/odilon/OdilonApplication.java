...
/**
 * <p>
 * <a href="https://odilon.io">Odilon</a> has three hierarchical layers (API,
 * Object Storage, Virtual File System) and about a dozen general services used
 * by them ( {@link SchedulerService}, {@link LockService},
 * {@link JournalService}, {@link CacheService}, {@link EncryptionService},
 * etc.).
 * </p>
 * 
 * <p>
 * See <a href="https://odilon.io/architecture.html">Odilon Architecture</a>
 * </p>
 * 
 * <ul>
 * <li><b>API</b><br/>
 * <p>
 * This is the HTTP/S interface used by client applications, like Odilon Java
 * SDK, it is a RESTFul API implemented with Spring Boot: Bucket and Object
 * operations, System info, and others. They interact directly with the Object
 * Storage, they do not see the lower layers. API Controllers: Bucket CRUD,
 * Object CRUD, System info,<br/>
 * API controllers interact with the {@link ObjectStorageService}, they do not
 * see the lower layers.
 * </p>
 * <br/>
 * </li>
 * <li><b>Object Storage Service</b><br/>
 * <p>
 * It is essentially an intermediary that downloads the requirements into the
 * Virtual File System <br/>
 * <br/>
 * </p>
 * </li>
 * <li><b>Virtual File System</b><br/>
 * <p>
 * The Virtual File System layer manages the repository on top of the OS File
 ...
 * <br/>
 * 
 * @author atolomei@novamens.com (Alejandro Tolomei) <br/>
 *         <br/>
