...
public class JCipherStreamEncryptorInfo implements StreamEncryptorInfo {
	...
	public JCipherStreamEncryptorInfo(JCipherStreamEncryptor jCipherStreamEncryption, String encryptedKey, String iv) {
		...
		this.encryptionAlgorithm = jCipherStreamEncryption.getEncryptionAlgorithm();

		this.keyAlgorithm = jCipherStreamEncryption.getKeyAlgorithm();

		this.keyEncryptor = jCipherStreamEncryption.getKeyEncryptor();
