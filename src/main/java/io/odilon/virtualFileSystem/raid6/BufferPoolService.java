 ...
 * ErasureCoding configuration (ie. 3, 6, 12, 24, 48). Default value is 20
 * buffers or the number of disks, whatever value is larger. The total buffers
 * can be set in odilon.properties (parameter -> <i>raid6.buffers</i>)
 * </p>
 * <p>
