 ...
 */
public abstract class ECRollbackHandler extends ECHandler {
	...
	public ECRollbackHandler(ECDriver driver, VirtualFileSystemOperation operation, boolean recovery) {
		super(driver);
