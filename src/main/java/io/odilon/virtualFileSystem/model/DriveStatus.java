...
public enum DriveStatus {
    ...
    public static DriveStatus fromValue(String value) {
        ...
        if (normalized.startsWith("DriveStatus{")) {
            ...
            if (idx >= 0) {
                ...
                if (firstQuote >= 0 && secondQuote > firstQuote) {
                    ...
                    normalized =
                            normalized.substring(firstQuote + 1, secondQuote);
                }
            }
        }
         ...
         * "notsync"
         *
         * Also supports enum constant names:
         * "NOTSYNC"
         */
    ...
    public static DriveStatus fromId(String id) {
        ...
        Check.requireNonNullStringArgument(id,
                "id is null or empty");
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "id can not be converted int Integer -> " + id);
        }
    }
    ...
    public static DriveStatus get(int code) {
        ...
        throw new IllegalArgumentException(
                "unsupported code -> " + String.valueOf(code));
    }
}