...
public class ODVFSObject implements VFSObject {
	...
	private static Logger logger = Logger.getLogger(ODVFSObject.class.getName());
	...
	public ODVFSObject(VFSBucket bucket, String objectName, VirtualFileSystemService vfs) {
		this.bucket=bucket;
